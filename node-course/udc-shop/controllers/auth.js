...
exports.postReset=(req,res,next)=>{
    crypto.randomBytes(32,(err,buf)=>{
        ...
        .then(user=>{
            if(!user){
                req.flash('error','No account corresponding to email');
                return res.redirect('/reset');
            }
            ...
            .then(result=>{
                ...
                transporter.sendMail({
                    ...
                    html:`
                        ...
                        <p>Click <a href="http://localhost:3000/reset/${token}">this link</a> to reset password.</p>
...
exports.postNewPassword=(req,res,next)=>{
    ...
    {
        req.flash('error','Password in both feilds should match');
